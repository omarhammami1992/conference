...
public final class ConferenceDto implements Conference{
    private final String name;
    private final String link;
    private final LocalDate startDate;
    private final LocalDate endDate;

    private ConferenceDto(String name, String link, LocalDate startDate, LocalDate endDate) {
        this.name = name;
        this.link = link;
    ...
    public static CreationResult create(String name, String link, LocalDate startDate, LocalDate endDate) {
        ...
        return new CreationResult(new ConferenceDto(name, link, startDate, endDate), new ConferenceValidated());
    }
    public String name() {
        return name;
    }
