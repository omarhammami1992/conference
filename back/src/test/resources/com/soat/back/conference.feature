Feature: Gestion des conférences
  ...
  Scenario: Création d'une conférence avec un système de tarification early bird
    ...
    And qui aura lieu à "3 rue tolbiac" "Paris" "France" de latitude "2.65321" et longitude "1.853158"
  ...
  Scenario: Récupérer la liste de toutes les conférences
    Given une liste de conférences enregistrées
      | id | name          | link                               | price | startDate  | endDate    | city  | country | fullAddress                | latitude | longitude |
      | 1  | Devoxx        | https://www.devoxx                 | 300   | 01-09-2022 | 30-09-2022 | Paris | France  | 3 rue tolbiac Paris France | 12345    | 54321     |
      | 2  | DataOps Rocks | https://summit-2022.dataops.rocks/ | 0     | 01-12-2022 | 30-12-2022 | Paris | France  | 3 rue tolbiac Paris France | 12345    | 54321     |
    When l'utilisateur consulte la liste de conferences
    Then les conférences à venir s'affichent
      | id | name          | link                               | fullPrice | startDate  | endDate    | isOnline | city  | country | fullAddress                | latitude | longitude |
      | 1  | Devoxx        | https://www.devoxx                 | 300       | 01-09-2022 | 30-09-2022 | False    | Paris | France  | 3 rue tolbiac Paris France | 12345    | 54321     |
      | 2  | DataOps Rocks | https://summit-2022.dataops.rocks/ | 0         | 01-12-2022 | 30-12-2022 | True     | Paris | France  | 3 rue tolbiac Paris France | 12345    | 54321     |
